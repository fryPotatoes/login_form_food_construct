                ...
                <div className="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                    {props.auth.user ? (
                        ...
                        <>
                            <Link
                                href={route('login')}
                                className="font-bold text-green-900 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                            >
                               Залогиниться
                            </Link>
                            ...
                            <Link
                                href={route('register')}
                                className="ml-4 font-semibold text-blue-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                            >
                                Зарегистрироваться
                            </Link>
                        </>
