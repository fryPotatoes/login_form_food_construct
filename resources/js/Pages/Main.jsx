...
export default function Main( auth, header, children, footer) {


    return (
        <GuestLayout

            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Главная страница!</h2>}
         footer={<h2 className="font-semibold text-xl text-gray-800 leading-tight">footer!</h2>}
        >
            <Head title="Main" />
            <div className="relative sm:flex sm:justify-center sm:items-center min-h-screen  bg-center bg-gray-100  selection:bg-green-500 selection:text-white">
                ...
                <div className="max-w-7xl mx-auto p-6 lg:p-8">
                    <div className="flex justify-center">
                        <svg width="350px" height="350px" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg"
